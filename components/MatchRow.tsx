...
export default function MatchRow({
  ...
  return (
    <div className="border-t border-turf-line py-2.5">
      {/* Time sits on its own line above the tie so a long team name can never
          squeeze it out on a narrow screen. */}
      {match.match_time?.trim() && (
